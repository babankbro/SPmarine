					...
					<Grid container spacing={3}>
						...
						<Grid md={6} xs={12}>
							<FormControl fullWidth required>
								...
								<OutlinedInput label="Max Barge" value={formData.maxBarge} onChange={handleChange} name="maxBarge" />
							</FormControl>
						</Grid>
						...
						<Grid md={6} xs={12}>
							<FormControl fullWidth>
								...
								<Select value={formData.type} onChange={handleChange} label="Type" name="type" variant="outlined">
						...
						<Grid container spacing={2}>
							<Grid md={6} xs={12}>
								<FormControl fullWidth margin="normal" required>
									...
									<OutlinedInput label="Min Speed" value={formData.minSpeed} onChange={handleChange} name="minSpeed" />
								</FormControl>
							</Grid>
							<Grid md={6} xs={12}>
								<FormControl fullWidth margin="normal" required>
									<InputLabel>Max Speed</InputLabel>
									<OutlinedInput label="Max Speed" value={formData.maxSpeed} onChange={handleChange} name="maxSpeed" />
								</FormControl>
							</Grid>
						</Grid>
						...
						<Grid md={6} xs={12}>
							<FormControl fullWidth required>
								...
								<OutlinedInput label="Engine Rpm" value={formData.engineRpm} onChange={handleChange} name="engineRpm" />
							</FormControl>
						</Grid>
